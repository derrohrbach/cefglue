namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefDialogHandler
    {
        ...
        /// "image/*") or individual file extensions (e.g. ".txt" or ".png").
        /// |accept_extensions| provides the semicolon-delimited list of file
        /// extensions for each accept filter. |accept_descriptions| provides the
        /// description for each accept filter. To display a custom dialog return true
