...
namespace Xilium.CefGlue.Interop
{
    ...
    internal unsafe struct cef_life_span_handler_t
    {
        ...
        internal IntPtr _on_before_popup_aborted;
        internal IntPtr _on_before_dev_tools_popup;
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate int on_before_popup_delegate(cef_life_span_handler_t* self, cef_browser_t* browser, cef_frame_t* frame, int popup_id, cef_string_t* target_url, cef_string_t* target_frame_name, CefWindowOpenDisposition target_disposition, int user_gesture, cef_popup_features_t* popupFeatures, cef_window_info_t* windowInfo, cef_client_t** client, cef_browser_settings_t* settings, cef_dictionary_value_t** extra_info, int* no_javascript_access);
        
        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
        #if !DEBUG
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate void on_before_popup_aborted_delegate(cef_life_span_handler_t* self, cef_browser_t* browser, int popup_id);
        
        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
        #if !DEBUG
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate void on_before_dev_tools_popup_delegate(cef_life_span_handler_t* self, cef_browser_t* browser, cef_window_info_t* windowInfo, cef_client_t** client, cef_browser_settings_t* settings, cef_dictionary_value_t** extra_info, int* use_default_window);
