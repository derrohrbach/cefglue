...
namespace Xilium.CefGlue.Interop
{
    ...
    internal unsafe struct cef_command_handler_t
    {
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate int on_chrome_command_delegate(cef_command_handler_t* self, cef_browser_t* browser, CefCommandId command_id, CefWindowOpenDisposition disposition);
        
        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
        #if !DEBUG
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate int is_chrome_app_menu_item_visible_delegate(cef_command_handler_t* self, cef_browser_t* browser, CefCommandId command_id);
        
        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
        #if !DEBUG
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate int is_chrome_app_menu_item_enabled_delegate(cef_command_handler_t* self, cef_browser_t* browser, CefCommandId command_id);
